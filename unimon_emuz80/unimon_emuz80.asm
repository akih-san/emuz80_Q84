...
BASIC_TOP	equ	1000H
BASIC_CST	equ	1000H	; basic cold start
BASIC_WST	equ	1003H	; basic warm start
...
OPNMSG:
	DB	CR,LF,"Universal Monitor for EMUZ80_Q84",CR,LF,00H
